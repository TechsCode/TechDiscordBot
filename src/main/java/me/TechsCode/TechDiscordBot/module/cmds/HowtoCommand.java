            ...
            e.replyEmbeds(
                    new TechEmbedBuilder("How To Use Hex & Gradient")
                            ...
                            .text("In order to use **Hex** and **Gradients** in Ultra and Insane plugins," +
                                    ...
                                    "To be able to create gradient colors in an easier way and having a preview of them you can use this [site](https://rgb.fede.tk/), you have to select as `Type` **TechsCode {#rrggbb>}** then write the text you want to use in `Message`, after modify the colors and finally copy the text where it will be written `Output`.")
